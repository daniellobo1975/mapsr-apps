...
loopJson <- function(input_json, input_json_cars) {
  ...
  # chama script pronto
  source("/mnt/volume_mapsr_11may22/mapsr_2.0-qa2/mapsr_api/src/script_R/mapsR.R")
  ConsultaCAR(fcar= car, ano_referencia= ano, versao_biomas= "v09", geoJson= "TRUE")
  
  source("/mnt/volume_mapsr_11may22/mapsr_2.0-qa2/mapsr_api/src/script_R/mapsR-Dinamizada.R")
  try(dinamizar(fcar= car, ano_referencia= ano, versao_biomas= "v09"))

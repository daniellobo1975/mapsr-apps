...
export class queryReportController extends BaseController<FarmReferece>{
  ...
  async executeRScript(fileName: any, fcar: any, ano_referencia: any) {
    let result = await R.callMethod("/mnt/volume_mapsr_11may22/mapsr_2.0/mapsr_api/src/script_R/mapsR.R", "ConsultaCAR", { fcar: fcar, ano_referencia: ano_referencia, versao_biomas: "v07", geoJson: "TRUE" });
    return result
  }

  async executeRScriptBuscar(longitude: any, latitude: any, ano_referencia: any) {
    let result = await R.callMethod("/mnt/volume_mapsr_11may22/mapsr_2.0/mapsr_api/src/script_R/mapsR.R", "busCAR", { longitude: longitude, latitude: latitude, ano_referencia: ano_referencia, versao_biomas: "v07" });
    return result
  }

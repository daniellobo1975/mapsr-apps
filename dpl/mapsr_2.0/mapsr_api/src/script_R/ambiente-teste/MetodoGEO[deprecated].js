...
let result = R.callMethod("/mnt/volume_mapsr_11may22/mapsr_2.0/mapsr_api/src/script_R/mapsR.R","ConsultaGEO", {longitude: "-21.310505605878213", latitude: "-48.154764491141345", ano_referencia: "2020", versao_biomas: "v07", geoJson: "TRUE"});
console.log(result);
// end

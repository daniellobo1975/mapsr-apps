export default {
  ...
  folderStorageNovoCSV: process.env.URL_STORAGE || '/mnt/volume_mapsr_11may22/fazendas/v07/',
  folderStorageNovoGEOJSON: process.env.URL_STORAGE || '/mnt/volume_mapsr_11may22/fazendas/v07/',
  folderStorageNovoJSON: process.env.URL_STORAGE || '/mnt/volume_mapsr_11may22/fazendas/v07/',

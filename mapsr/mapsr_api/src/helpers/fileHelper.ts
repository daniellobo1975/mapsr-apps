...
export class FileHelper {
    ...
    static async validFolderExistAsync(ano: string, path: string, nameFile: string) {
        const isFolderExist = fs.existsSync("/mnt/volume_mapsr_11may22/fazendas_3000/v09/" + ano + "/" + path + "/" + nameFile);

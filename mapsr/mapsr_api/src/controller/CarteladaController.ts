...
export class CarteladaController {
    async cartelada(req: Request) {
        ...
        const lsimplesProcess = spawn('Rscript', [
            '/mnt/volume_mapsr_11may22/mapsr/mapsr_api/src/script_R/lsimples.R',
            'loopJson',
            JSON.stringify(anos),
            JSON.stringify(cars)
        ]);
            ...
            for (const ano of anos) {
                for (const car of cars) {
                    ...
                    try {
                        ...
                        const url = 'https://farmforest.com.br/version-test/api/1.1/wf/post_geojson';
                        const payload = {
                            body: objetoJson
                        };
                ...
                for (const car of cars) {
                    ...
                    try {
                        ...
                        let config = {
                            ...
                            url: 'https://farmforest.com.br/version-test/api/1.1/wf/getjson',
                            headers: {

...
var ClientController = /** @class */ (function (_super) {
    ...
    function ClientController() {
        var _this = _super.call(this, Client, false) || this;
        _this._repository2 = getRepository(Client);
        _this._repository_Farm = getRepository(Farm);
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, getRepository(Client).findOne({ uid: uid, deleted: true })];
                    case 1:
                        validate1 = _b.sent();
                        return [4 /*yield*/, getRepository(Client).findOne({ clientName: clientName })];
                    case 2:
                        validate2 = _b.sent();
                        return [4 /*yield*/, getRepository(Client).findOne({ email: email })];
                    case 3:
                        validate3 = _b.sent();
                        if (validate2) {
                        ...
                        return [4 /*yield*/, FileHelper.writePicture(_client.photo)];
                    case 4:
                                            ...
                                            return [4 /*yield*/, Promise.all(farm.farmReferences.map(function (farmRef) { return __awaiter(_this, void 0, void 0, function () {
                                                    ...
                                                    return __generator(this, function (_a) {
                                                        switch (_a.label) {
                                                            ...
                                                            case 1:
                                                                _a.trys.push([1, 9, , 10]);
                                                                return [4 /*yield*/, FileHelper.fileBase64(farmRef.app_shp, 'shp', null)];
                                                            case 2:
                                                                file = _a.sent();
                                                                fileName = file.substring(0, file.length - 4);
                                                                farmRef.app_shp = file;
                                                                if (!farmRef.app_dbf) return [3 /*break*/, 4];
                                                                return [4 /*yield*/, FileHelper.fileBase64(farmRef.app_dbf, 'dbf', fileName)];
                                                            case 3:
                                                                file = _a.sent();
                                                            ...
                                                            case 4:
                                                                ...
                                                                return [4 /*yield*/, FileHelper.fileBase64(farmRef.app_prj, 'prj', fileName)];
                                                            case 5:
                                                                file = _a.sent();
                                                            ...
                                                            case 6:
                                                                ...
                                                                return [4 /*yield*/, FileHelper.fileBase64(farmRef.app_shx, 'shx', fileName)];
                                                            case 7:
                                                                file = _a.sent();
                                                            ...
                                                            case 11:
                                                                ...
                                                                return [4 /*yield*/, FileHelper.fileBase64(farmRef.biomas, 'tif', null)];
                                                            case 12:
                                                                file = _a.sent();
                                                                // fileName = file.substring(0, file.length-4);
                                                                farmRef.biomas = file;
                                                            ...
                                                            case 15:
                                                                ...
                                                                return [4 /*yield*/, FileHelper.fileBase64(farmRef.car_shp, 'shp', null)];
                                                            case 16:
                                                                file = _a.sent();
                                                                fileName = file.substring(0, file.length - 4);
                                                                farmRef.car_shp = file;
                                                                if (!farmRef.car_dbf) return [3 /*break*/, 18];
                                                                return [4 /*yield*/, FileHelper.fileBase64(farmRef.car_dbf, 'dbf', fileName)];
                                                            case 17:
                                                                file = _a.sent();
                                                            ...
                                                            case 18:
                                                                ...
                                                                return [4 /*yield*/, FileHelper.fileBase64(farmRef.car_prj, 'prj', fileName)];
                                                            case 19:
                                                                file = _a.sent();
                                                            ...
                                                            case 20:
                                                                ...
                                                                return [4 /*yield*/, FileHelper.fileBase64(farmRef.car_shx, 'shx', fileName)];
                                                            case 21:
                                                                file = _a.sent();
                                                            ...
                                                            case 23:
                                                                ...
                                                                return [3 /*break*/, 24];
                                                            case 24:
                                                                repo3 = getRepository(FarmReferece);
                                                                _a.label = 25;
                                                            case 25:
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _client = request.body;
                        return [4 /*yield*/, getRepository(Client).findOne({ uid: uid })];
                    case 1:
                        validate = _b.sent();
                        return [4 /*yield*/, getRepository(Client).findOne({ uid: uid, deleted: true })];
                    case 2:

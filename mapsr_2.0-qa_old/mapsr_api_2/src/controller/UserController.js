...
var UserController = /** @class */ (function (_super) {
    ...
    function UserController() {
        ...
        _this._repository2 = getRepository(User);
        return _this;
    }
                    ...
                    case 1:
                        ...
                        if (user) {
                            ...
                            return [2 /*return*/, {
                                    ...
                                    message: {
                                        user: _payload,
                                        token: sign(__assign(__assign({}, _payload), { tm: new Date().getTime() }), config.secretyKey)
                                    }
                                }];
                        }
                        else
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, getRepository(User).findOne({ email: email })];
                    case 1:
                        validation1 = _b.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        link = config.mailCredencials.siteUrl;

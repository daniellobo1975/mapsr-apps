...
var FarmController = /** @class */ (function (_super) {
    ...
    function FarmController() {
        var _this = _super.call(this, Farm, false) || this;
                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        ...
                                        case 23:
                                            ...
                                            return [3 /*break*/, 24];
                                        case 24:
                                            repo2 = getRepository(FarmReferece);
                                            _a.label = 25;
                                        case 25:
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, getRepository(Farm).findOne({ uid: uid })];
                    case 1:
                        validate = _b.sent();
                        return [4 /*yield*/, getRepository(Farm).findOne({ uid: uid, deleted: true })];
                    case 2:
                        validate1 = _b.sent();
                        return [4 /*yield*/, getRepository(Client).findOne({ uid: clientId })];
                    case 3:
                        validate2 = _b.sent();
                        if (!validate2)

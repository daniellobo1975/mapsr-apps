...
var FarmRefController = /** @class */ (function (_super) {
    ...
    function FarmRefController() {
        var _this = _super.call(this, FarmReferece, false) || this;
        _this._repository_FarmReferece = getRepository(FarmReferece);
        _this._repository_FarmDefaultReferece = getRepository(farmDefaultReference);
        _this._repository_QueryReport = getRepository(queryReport);
        _this._repository_User = getRepository(User);
        return _this;
    }
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        qResult = new queryReport();
                        queryReportResultModel = new QueryReportResultModel();
                    ...
                    case 2:
                        ...
                        repo = getRepository(FarmReferece);
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, FileHelper.validFolderExistAsync(_queryReportExecuted.ano_referencia, "geoJson", _queryReportExecuted.numCar + ".GeoJSON")];
                    case 5:
                        folderExistsGeoJson = _b.sent();
                        return [4 /*yield*/, FileHelper.validFolderExistAsync(_queryReportExecuted.ano_referencia, "csv", _queryReportExecuted.numCar + ".csv")];
                    case 6:
                        folderExistsCSV = _b.sent();
                        return [4 /*yield*/, FileHelper.validFolderExistAsync(_queryReportExecuted.ano_referencia, "json", _queryReportExecuted.numCar + ".json")];
                    case 7:
                    ...
                    case 14:
                        ...
                        return [4 /*yield*/, FileHelper.validFolderExistAsync(_queryReportExecutedWithCar.ano_referencia, "geoJson", _queryReportExecutedWithCar.numCar + ".GeoJSON")];
                    case 15:
                        folderExistsGeoJson = _b.sent();
                        return [4 /*yield*/, FileHelper.validFolderExistAsync(_queryReportExecutedWithCar.ano_referencia, "csv", _queryReportExecutedWithCar.numCar + ".csv")];
                    case 16:
                        folderExistsCSV = _b.sent();
                        return [4 /*yield*/, FileHelper.validFolderExistAsync(_queryReportExecutedWithCar.ano_referencia, "json", _queryReportExecutedWithCar.numCar + ".json")];
                    case 17:
                        folderExistsJson = _b.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.trys.push([1, 9, , 10]);
                        return [4 /*yield*/, FileHelper.fileBase64(app_shp, 'shp', null)];
                    case 2:
                        file = _b.sent();
                        fileName = file.substring(0, file.length - 4);
                        _farmRef.app_shp = file;
                        if (!_farmRef.app_dbf) return [3 /*break*/, 4];
                        return [4 /*yield*/, FileHelper.fileBase64(app_dbf, 'dbf', fileName)];
                    case 3:
                        file = _b.sent();
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, FileHelper.fileBase64(app_prj, 'prj', fileName)];
                    case 5:
                        file = _b.sent();
                    ...
                    case 6:
                        ...
                        return [4 /*yield*/, FileHelper.fileBase64(app_shx, 'shx', fileName)];
                    case 7:
                        file = _b.sent();
                    ...
                    case 11:
                        ...
                        return [4 /*yield*/, FileHelper.fileBase64(biomas, 'tif', null)];
                    case 12:
                        file = _b.sent();
                    ...
                    case 15:
                        ...
                        return [4 /*yield*/, FileHelper.fileBase64(car_shp, 'shp', null)];
                    case 16:
                        file = _b.sent();
                        fileName = file.substring(0, file.length - 4);
                        _farmRef.car_shp = file;
                        if (!_farmRef.car_dbf) return [3 /*break*/, 18];
                        return [4 /*yield*/, FileHelper.fileBase64(car_dbf, 'dbf', fileName)];
                    case 17:
                        file = _b.sent();
                    ...
                    case 18:
                        ...
                        return [4 /*yield*/, FileHelper.fileBase64(car_prj, 'prj', fileName)];
                    case 19:
                        file = _b.sent();
                    ...
                    case 20:
                        ...
                        return [4 /*yield*/, FileHelper.fileBase64(car_shx, 'shx', fileName)];
                    case 21:
                        file = _b.sent();
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        if (!biomas)
                            return [2 /*return*/, { status: 400, errors: ['Adicione o arquivo Biomas'] }];
                        _farmRef = request.body;
                        return [4 /*yield*/, getRepository(FarmReferece).findOne({ uid: uid })];
                    case 1:
                        validate = _b.sent();
                        return [4 /*yield*/, getRepository(FarmReferece).findOne({ uid: uid, deleted: true })];
                    case 2:
                        validate1 = _b.sent();
                        return [4 /*yield*/, getRepository(Farm).findOne({ uid: farmId })];
                    case 3:
                        validate2 = _b.sent();
                        if (!validate2)
                    ...
                    case 5:
                        ...
                        return [4 /*yield*/, FileHelper.fileBase64(app_shp, 'dbf', fileName)];
                    case 6:
                        file = _b.sent();
                        _farmRef.app_shp = file;
                        _b.label = 7;
                    case 7:
                        ...
                        return [4 /*yield*/, FileHelper.fileBase64(app_shp, 'prj', fileName)];
                    case 8:
                        file = _b.sent();
                        _farmRef.app_prj = file;
                        _b.label = 9;
                    case 9:
                        ...
                        return [4 /*yield*/, FileHelper.fileBase64(app_shp, 'shx', fileName)];
                    case 10:
                        file = _b.sent();
                        _farmRef.app_shx = file;
                        _b.label = 11;
                    ...
                    case 17:
                        ...
                        return [4 /*yield*/, FileHelper.fileBase64(car_shp, 'dbf', fileName)];
                    case 18:
                        file = _b.sent();
                        _farmRef.car_shp = file;
                        _b.label = 19;
                    case 19:
                        ...
                        return [4 /*yield*/, FileHelper.fileBase64(car_shp, 'prj', fileName)];
                    case 20:
                        file = _b.sent();
                        _farmRef.car_prj = file;
                        _b.label = 21;
                    case 21:
                        ...
                        return [4 /*yield*/, FileHelper.fileBase64(car_shp, 'shx', fileName)];
                    case 22:
                        file = _b.sent();
                        _farmRef.car_shx = file;
                        _b.label = 23;
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, getRepository(farmDefaultReference).findOne({ farmId: farmId })];
                    case 1:
                        validate1 = _b.sent();
                        return [4 /*yield*/, getRepository(Farm).findOne({ uid: farmId })];
                    case 2:
                        ...
                        return [4 /*yield*/, getRepository(FarmReferece).findOne({ farmId: farmId, uid: defaultReference })];
                    case 3:
                        validate2 = _b.sent();
                        if (!!validate2) return [3 /*break*/, 5];
                        return [4 /*yield*/, getRepository(FarmReferece).findOne({ uid: defaultReference })];
                    case 4:
                        validate4 = _b.sent();
                        if (validate4) {
                        ...
                        _b.label = 5;
                    case 5:
                        _farmDefaultRef = new farmDefaultReference();
                        if (validate1) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 6, , 7]);
                        _userToken = verify(token, config.secretyKey);
                        _a.label = 2;
                    case 2:
                        _a.trys.push([2, 4, , 5]);

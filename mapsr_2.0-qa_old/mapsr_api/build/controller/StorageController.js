...
var StorageController = /** @class */ (function () {
    ...
    StorageController.prototype.getFile = function (req) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                filePath = "".concat(config_1.default.folderStorage, "/").concat(req.params.filename);
    ...
    StorageController.prototype.getOutputFile = function (req) {
        return __awaiter(this, void 0, void 0, function () {
            var filePath;
            return __generator(this, function (_a) {
                filePath = "".concat(config_1.default.folderStorage, "/output/").concat(req.params.filename);
                return [2 /*return*/, { file: path.resolve(filePath) }];
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        filePath = "".concat(config_1.default.folderStorageNovoGEOJSON, "/").concat(yearFolder, "/geoJson/").concat(req.params.filename);
                    ...
                    case 2:
                        if (typeArchive[1].toString().toLowerCase().includes('csv')) {
                            filePath = "".concat(config_1.default.folderStorageNovoCSV, "/").concat(yearFolder, "/csv/").concat(req.params.filename);
                            return [2 /*return*/, { file: path.resolve(filePath) }];
                        }
                        else if (typeArchive[1].toString().toLowerCase().includes('json')) {
                            filePath = "".concat(config_1.default.folderStorageNovoJSON, "/").concat(yearFolder, "/json/").concat(req.params.filename);
                            return [2 /*return*/, { file: path.resolve(filePath) }];
                        }
                        _a.label = 3;
                    case 3: return [2 /*return*/];

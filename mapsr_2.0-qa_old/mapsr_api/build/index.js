...
app.use(auth_1.default); //passa por ele antes das rotas
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                console.log("Express server has started on port ".concat(config_1.default.port, ". Open http://localhost:").concat(config_1.default.port, " to see results"));
                return [3 /*break*/, 4];
            case 3:
                error_1 = _a.sent();
                if (error_1 == 'ER_DUP_ENTRY') {
                    return [2 /*return*/, { message: 'Dado duplicado não aceito' }];
                }
                else {

...
var queryReport = /** @class */ (function (_super) {
    ...
    __decorate([
        (0, typeorm_1.OneToOne)(function () { return FarmReferece_1.FarmReferece; }, function (farmRef) { return farmRef.uid; }, { eager: true, nullable: true }),
        (0, typeorm_1.JoinColumn)({ referencedColumnName: "uid", name: 'farmRef' /*nome a ser exibido no bd*/ }),
        __metadata("design:type", FarmReferece_1.FarmReferece)
    ], queryReport.prototype, "farmRefEntity", void 0);
    __decorate([
    ...
    __decorate([
        (0, typeorm_1.Column)({ type: 'varchar', length: 200, nullable: true }),
        __metadata("design:type", String)
    ], queryReport.prototype, "result_json", void 0);
    __decorate([
        (0, typeorm_1.Column)({ type: 'varchar', length: 200, nullable: true }),
        __metadata("design:type", String)
    ], queryReport.prototype, "ano_referencia", void 0);
    __decorate([
        (0, typeorm_1.Column)({ type: 'varchar', length: 200, nullable: true }),
        __metadata("design:type", String)
    ], queryReport.prototype, "erro_geracao_arquivo", void 0);
    __decorate([
        (0, typeorm_1.Column)({ type: 'varchar', length: 200, nullable: true }),
        __metadata("design:type", String)

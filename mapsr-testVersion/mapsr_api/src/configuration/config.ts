export default {
  ...
  folderStorageNovoCSV: process.env.URL_STORAGE || '/mnt/volume_mapsr_11may22/fazendas_3000/v08/',
  folderStorageNovoGEOJSON: process.env.URL_STORAGE || '/mnt/volume_mapsr_11may22/fazendas_3000/v08/',
  folderStorageNovoJSON: process.env.URL_STORAGE || '/mnt/volume_mapsr_11may22/fazendas_3000/v08/',
